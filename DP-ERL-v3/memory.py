...
class Buffer:
    ...
    def store(self, datum):
        self.cache_buffer.append(datum)
...
class HMemory:
    ...
    def add(self, cache_buffer):

        for datum in cache_buffer:
    ...
    def sample(self, batch_size):
        ...
        return (self.states[batch_inds], self.n_states[batch_inds], self.actions[batch_inds],
                self.rewards[batch_inds], self.dones[batch_inds])
